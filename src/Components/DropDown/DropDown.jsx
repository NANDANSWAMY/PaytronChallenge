...
import listenForOutsideClick from './listenOutside';
...
const DropDown = (props) => {
  ...
  useEffect(()=>
  listenForOutsideClick(listening, setListening, menuRef, setOpen), [listening, open])
  ...
  return (
    <div className={`${classes.container} ${props.className}`} style={props.style}>
      ...
      <button onClick={handleOpen} className={classes.dropdown} ref={menuRef}>
        {props.leftIcon}
